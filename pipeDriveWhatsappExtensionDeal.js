...
class pipeDriveWhatsappExtensionDeal {
    constructor() {}
    init() {
    ...
    destroy() {
        if (document.querySelector('.whatsappPipelineDeal')) document.querySelector('.whatsappPipelineDeal').remove();
    }
    ...
    createButton() {
        ...
        whtpipeButton.classList.add('whatsappPipelineDeal');
        ...
        this.whtpipeButtonElement.addEventListener('click', () => {
            const phone = document.querySelector('.phoneField .salesPhone .phoneNumber .value');
