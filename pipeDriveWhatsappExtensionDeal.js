...
class pipeDriveWhatsappExtensionDeal {
  ...
  destroy() {
    if (this.whtpipeButtonElement) {
      this.whtpipeButtonElement.remove();
      this.whtpipeButtonElement = null;
    }
  }
  ...
  createButton() {
    jQuery(document).ready(() => {
      this.destroy();
      let whtpipeButton = jQuery("<button />", {
        type: "button",
        id: "whtpipeButton",
        html: this.icon,
        class: "whatsappPipelineDeal"
      });
      whtpipeButton.on("click", () => {
        let phone = jQuery(
      ...
      this.whtpipeButtonElement = jQuery("#whtpipeButton");
    });
  }
}
